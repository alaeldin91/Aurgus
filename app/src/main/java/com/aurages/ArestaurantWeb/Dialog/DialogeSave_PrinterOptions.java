...
public class DialogeSave_PrinterOptions extends Dialog {
  ...
  public static   String type;
    ...
    public DialogeSave_PrinterOptions(@NonNull Activity a, FragmentManager fragmentManager, String type) {
        super(a);
        this.activity = a;
