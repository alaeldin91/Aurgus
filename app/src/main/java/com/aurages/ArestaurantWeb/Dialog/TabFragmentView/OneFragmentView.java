...
public class OneFragmentView extends Fragment {

    View view;

    public OneFragmentView() {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if(webOrders_models.size()>0){
            ...
            adapterViewOrders = new AdapterViewOrders(getContext(),webOrders_models,getFragmentManager(),"one");
