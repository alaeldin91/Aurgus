...
public class ThreeFragmentView extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if(webOrders_models.size()>0){
            adapterViewOrders = new AdapterViewOrders(getContext(),webOrders_models,getFragmentManager(),"three");
