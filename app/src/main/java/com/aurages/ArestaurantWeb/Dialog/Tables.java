...
import com.aurages.ArestaurantWeb.Adapter.AdapterTablePlace;
...
public class Tables extends AppCompatDialogFragment {
    public static RecyclerView tables_rec, tables_place_rec;
    public static ArrayList<ModelTables> tableModels = new ArrayList<>();
    public static AdapterTablePlace adapterTablePlace;
    public static AdapterTables adapterTables;
    String type;
    public Tables(String type) {
        this.type = type;
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
       ...
       // adapterTables = new AdapterTables(getContext(), tableModels, type,Tables.this);
