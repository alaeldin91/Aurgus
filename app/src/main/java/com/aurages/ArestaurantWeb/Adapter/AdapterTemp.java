...
public class AdapterTemp extends RecyclerView.Adapter<AdapterTemp.ViewHolder> {
    ...
    private AdapterTemp.ItemClickListener mClickListener;
...
//    private FragmentManager fragmentManager;
    ...
    public AdapterTemp(Context context, ArrayList<Temp_Order> t) {
...
//    this.fragmentManager = fragmentManager;
    ...
    //   temp_no= position+1;
        ...
        position=position+1;
        holder.temp_no.setText(""+position+"");
      ...
      float  price= t.getPrice();
       ...
       total += t.getPrice() * t.getQty();
        ...
        double o_tax = round(total, 1) * 15 / 100;
...
//        });
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
      public   TextView temp_no,temp_name, temp_price, temp_qty, temp_total;
        EditText discount;
        ...
        ViewHolder(View itemView) {
            ...
            temp_price = itemView.findViewById(R.id.temp_price);temp_name = itemView.findViewById(R.id.temp_name);
        ...
        public  void minQty(){
          Temp_Order  temp_orders= new Temp_Order();
            double qty = inc_dec(temp_qty.getText().toString(),0);
            double totalprice = calcTotal(qty,temp_orders.getPrice());
            temp_qty.setText(String.valueOf(round(qty,1)));
            temp_price.setText(String.valueOf(round(totalprice,1)));
    ...
    public double calcTotal(double qty, double price) {
        return qty*price;
    }
...
//                , "New Order");
   ...
   //}
    public void openDialogEditTemp(String temp_id, String MatCode,Context ctx) {
        TempEditDialog tempEditd = new TempEditDialog( scanForActivity(ctx),temp_id,MatCode);
        Bundle args = new Bundle();
        args.putString("temp_id", temp_id);
