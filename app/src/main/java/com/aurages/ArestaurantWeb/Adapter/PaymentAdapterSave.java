...
public class PaymentAdapterSave extends RecyclerView.Adapter<PaymentAdapterSave.ViewHolder> {
        ...
        public PaymentAdapterSave(ArrayList<Model_PaymentType> paymentTypes,ArrayList<ImageModel> imageModels,String type, Context context,payment_save payment_save) {
            ...
            this.payment_save=payment_save;
        }
            ...
            holder.payment_image.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                        ...
                        if (bill_id.equals("78f3e350-df9e-11ea-aca2-0fc22d0889ad")) {
                            ...
                            DialogeSaveOptions printerOptions = new DialogeSaveOptions(scanForActivity(context), fragmentManager, type);
                            printerOptions.openTableDialog(type);
                            payment_save.dismiss();
